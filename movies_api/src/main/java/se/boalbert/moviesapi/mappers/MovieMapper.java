...
public class MovieMapper {
	...
	public MovieDto mapp(MovieEntity movieEntity) {
		return new MovieDto(movieEntity.getId(), movieEntity.getTitle(), movieEntity.getReleaseDate(), movieEntity.getRunTimeMins(), movieEntity.getImdbRating(), movieEntity.getGenreId(), movieEntity.getDirectorId(), movieEntity.getLanguageId());
	}

	public MovieEntity mapp(MovieDto movieDto) {

		return new MovieEntity(movieDto.getId(), movieDto.getTitle(), movieDto.getReleaseDate(), movieDto.getRunTimeMins(), movieDto.getImdbRating(), movieDto.getGenreId(), movieDto.getDirectorId(), movieDto.getLanguageId());
