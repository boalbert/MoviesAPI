...
public class MvcTestMovies {
	...
	void callingUrlMoviesWithId_ReturnOneMovieAsJson() throws Exception {
		...
		when(service.getOne(1L))
				.thenReturn(Optional.of(new MovieDto(1L, "Title", LocalDate.of(2020, 1, 1), 123, 5.0,1L,1L,1L)));
	...
	void callingAllMovies_ReturnListOfAllMovies() throws Exception {
		when(service.getAllMovies())
				.thenReturn(List.of(
						new MovieDto(1, "Title", LocalDate.of(1999, 1, 1), 123, 5.0,1L,1L,1L),
						new MovieDto(2, "Title", LocalDate.of(1999, 1, 1), 123, 5.0,1L,1L,1L)));
	...
	void whenValidMoviePosted_thenReturnsHttpStatusCreated() throws Exception {
		MovieDto newMovieDto = new MovieDto(1, "Title", LocalDate.of(1999, 1, 1), 123, 5.0,1L,1L,1L);
	...
	void whenNullValue_thenReturns400() throws Exception {
		MovieDto newMovieDto = new MovieDto(anyLong(), "Title", LocalDate.of(1999, 1, 1), 123, 5.0,1L,1L,1L);
